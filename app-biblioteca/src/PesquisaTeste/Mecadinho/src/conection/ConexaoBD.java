package PesquisaTeste.Mecadinho.src.conection;
...
public class ConexaoBD {
	...
	private ConexaoBD() throws IOException {
		try {
			...
			System.out.println("Conex�oDB[conexao OK]");
	...
	public static Connection getConexao() throws IOException {
		...
		try {
			...
			clients++;
			System.out.println("Conex�oDB[conexao cliente]");
			return connection;
		} catch (Exception e) {
	...
	public void desligar() {
		System.out.println("Conex�oDB[Desliga cliente]");
		clients--;
		if (clients > 0) {
			return;
		}
		try {
			...
			instance = null;
			connection = null;
			System.out.println("Conex�oDB[conexao fechada]");
